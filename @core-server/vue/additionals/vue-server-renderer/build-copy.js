...
const TemplateRenderer = require('./custom/TemplateRenderer.js')
...
function createRenderer$1 (ref) {
    ...
    var modules = ref.modules; if ( modules === void 0 ) 
        modules = []

    var directives = ref.directives; if ( directives === void 0 ) 
        directives = {}

    var isUnaryTag = ref.isUnaryTag; if ( isUnaryTag === void 0 ) 
        isUnaryTag = (function () {
            return false 
        })
