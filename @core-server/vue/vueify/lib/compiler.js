...
compiler.compile = function (content, filePath, subOptions, cb) {
    var isProduction = process.env.NODE_ENV === 'production'
    var isServer = subOptions._flags.isServer // | process.env.VUE_ENV === 'server'
    ...
    // check whether script/template has changed
      ...
      ': module.exports)\n'
        ...
        '  hotAPI = hotAPI.__esModule ? hotAPI.default : hotAPI\n' +
