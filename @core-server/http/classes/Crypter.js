...
class Crypter
{
    ...
    * @param secret {String}
    */
    decryptAlgo(algo, length, content, secret, subIv, encoding = 'base64')
    {
        try
        {
    ...
    * @param secret {String}
    */
    decrypt(content, secret, subIv, encoding = 'base64')
    {
        return this.decryptAlgo('aes256', 32, content, secret, subIv, encoding);
    }
    ...
    * @param secret {String}
    */
    encrypt(content, secret, subIv, encoding = 'base64')
    {
        try
        {
            ...
            decipher.setAutoPadding(true);
            var dec = decipher.update(content, 'utf8', encoding);
    ...
    * @param secret {String}
    */
    decryptJSON(content, secret, subIv, encoding = 'base64')
    {
        content = this.decrypt(content, secret, subIv, encoding);
